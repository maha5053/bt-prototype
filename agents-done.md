...
## Сессия 2026-06-24 (@end-session)

- **Хранение / аликвоты:** кнопка «Добавить аликвоту» перенесена ниже списка сворачиваемых аликвот; новая аликвота раскрывается сразу после добавления.
- **Файл:** `src/pages/ProductionPages.tsx`.
- **Проверка:** локально без полной сборки на этом шаге; далее в сессии будет `npm run build`, commit, push, deploy.
