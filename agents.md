...
- **`tasks/production-ux-plan.md`** — план UX по модулю «Производство» (P1–P3, чеклист в YAML + описание пунктов).

## Модуль «Производство» + Конструктор процессов (частично реализован)

Полный план модуля: `.cursor/plans/production_process_module_e6aef1f7.plan.md` (или копия в корне воркспейса при необходимости).

**Бэклог точечных UX-правок** (журнал и карточка, P1–P3): [`../tasks/production-ux-plan.md`](../tasks/production-ux-plan.md) — выполнять выборочно; в коде пока не всё из списка.
